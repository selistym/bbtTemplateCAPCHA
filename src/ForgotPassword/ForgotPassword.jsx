					...
					<div className="col-sm-4 col-xs-10" style={{ padding: '50px 30px', background: 'white', borderRadius: '3px', marginTop: '25vh' }}>
						<div>
							...
							<form name="form" onSubmit={handleSubmit}>
								...
								<div className='form-group captchaForm' style={{textAlign:'center'}}>
								<ReCaptcha sitekey="6Ldn6qUUAAAAACc50evcxq8nAM43Esh_sQ81c0qN" style={{display:'table'}} render="explicit" size="normal" />
								</div>
								<div className="form-group">
									<button className="btn btn-warning" style={{ width: '100%' }}>Send recovery email</button>
								</div>
								<br />
								<div className="text-left">
									<a href="#"><Icon type="left" /> Sign In</a>
								</div>								
							</form>
						</div>
					</div>
